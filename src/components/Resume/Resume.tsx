    ...
    >
      ...
      <div className="resume-box">
        <div className="resume-box-left">
          <img className="cta" src="../../assets/images/cta.png" />
        </div>
        ...
        <div className="resume-box-right">
          ...
          <a
            download="Mahdi_EL_Hasra_Lebenslauf.pdf"
            href="../../assets/documents/Mahdi_EL_Hasra_Lebenslauf.pdf"
          >
            <button
              className="download"
